package com.mycompany.charliebookstore.database
...
import com.mycompany.charliebookstore.model.*
import com.mycompany.charliebookstore.ui.activities.*
import com.mycompany.charliebookstore.ui.fragments.DashboardFragment
import com.mycompany.charliebookstore.ui.fragments.OrdersFragment
import com.mycompany.charliebookstore.ui.fragments.ProductFragment
import com.mycompany.charliebookstore.utils.Constants
    ...
    fun getItemsForDashboard(fragment: DashboardFragment){
        db.collection("products")
            ...
            .addOnFailureListener {
                ...
                println("Erro com itens do painel.")
            }
    }
   ...
   fun removeItemInCart(context: Context,cartId: String){
       db.collection("cart_items")
           ...
           .addOnSuccessListener {
               ...
               when(context){
                   is CartListActivity ->{
                       context.hideProgressBar()
                       println("Erro ao remover do Carinho.")
                   }
               }
           }
   }
    ...
    fun updateAddress(activity: EditAddAddressActivity, addressInfo: Address, addressId: String) {
        ...
        db.collection("addresses")
            ...
            // Chama aqui uma função da atividade base para transferir o resultado para ela.
                activity.editAddAddressToDBSuccess()
            }
            .addOnFailureListener { e ->
                activity.hideProgressBar()
    ...
    fun getSoldProductsList(activity: SoldProductsActivity){
        db.collection("sold_products")
            ...
            .addOnFailureListener {
                println("Erro ao obter produtos vendidos")
                it.printStackTrace()
                activity.hideProgressBar()
            }
    }
